...
while True:
    ...
    if opcao == '5':
        ...
        if dormir > estudar or dormir > passear or dormir > ativ:
            x = 'DORMIR'
        if estudar > dormir or estudar > passear or estudar > ativ:
            x = 'ESTUDAR'
        if passear > dormir or passear > estudar or passear > ativ:
            x = 'PASSEAR'
        if ativ > dormir or ativ > passear or ativ > estudar:
            x = 'OUTRAS ATIVIDADES'
        print('\nESTATISTICAS')
